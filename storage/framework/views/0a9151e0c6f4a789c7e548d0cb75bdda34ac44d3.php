<?php $__env->startSection('head'); ?>
    <h1><?php echo e($testResult->user->fname." ".$testResult->user->lname); ?></h1>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-sm-8">
            <h3><?php echo e($testResult->user->course); ?></h3>
            <h4>
                <?php if($testResult->user->gender == 0): ?> Male
                <?php else: ?> Female
                <?php endif; ?>
                <br>
                <?php echo e($testResult->user->age); ?> years old
            </h4>
        </div>
    </div>
   <!--  <div class="row">
