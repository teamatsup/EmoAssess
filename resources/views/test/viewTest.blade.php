                        ...
                        <div class="input-group">
                            @if($testquestion->reverse == 0)
                                <label class="radio-inline">
                                    <input type="radio" name="{{$testquestion->id}}" id="1" value="1" required>1
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="{{$testquestion->id}}" id="2" value="2" required>2
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="{{$testquestion->id}}" id="3" value="3" required>3
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="{{$testquestion->id}}" id="4" value="4" required>4
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="{{$testquestion->id}}" id="5" value="5" required>5
                                </label>
                            @else
                                <label class="radio-inline">
                                    <input type="radio" name="{{$testquestion->id}}" id="1" value="5" required>1
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="{{$testquestion->id}}" id="2" value="4" required>2
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="{{$testquestion->id}}" id="3" value="3" required>3
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="{{$testquestion->id}}" id="4" value="2"required>4
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="{{$testquestion->id}}" id="5" value="1" required>5
                                </label>
                            @endif
                        </div>
                    </div>
